...
class MainActivity : FlutterActivity() {
    ...
    private fun scheduleAlarmFromPayload(call: MethodCall): Boolean {
        val triggerAtMs =
            call.argument<Number>("triggerAtMs")?.toLong()
                ?: return false
        val activityMonitor = call.argument<Int>("activityMonitor") ?: return false
        val locationMonitor = call.argument<Int>("locationMonitor") ?: 0
        val location = call.argument<String>("location") ?: ""
        val isWeather = call.argument<Int>("isWeather") ?: 0
