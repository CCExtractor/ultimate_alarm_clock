...
class PhotoChallenge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      onTap: () async {
        ...
        await controller.requestPhotoPermission(context);
      },
      trailing: InkWell(
        child: Wrap(
          ...
          children: [
            Obx(
              () => Text(
                controller.isPhotochallengeEnabled.value == true
                    ? 'Enabled'.tr
                    : 'Off'.tr,
                style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                      color: (controller.isPhotochallengeEnabled.value == false)
