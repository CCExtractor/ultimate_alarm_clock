                ...
                child: (controller.mutexLock.value == true)
                  ...
                  children: [
                    ...
                    Obx(
                        ...
                        children: [
                          // --- ADDED THE DURATION SLIDER HERE ---
                          ListTile(
                            title: Row(
                              children: [
                                Text(
                                ...
                                const Spacer(),
                                Obx(() => Text(
                                  '${controller.challengeDuration.value}s',
                                  style: TextStyle(
                                    color: themeController
                                        .primaryTextColor.value,
                            ...
                            subtitle: Obx(
                                  () => Slider(
                                value: controller.challengeDuration.value.toDouble(),
                                min: 5,
                                max: 60,
                                divisions: 11, // 5, 10, 15, 20...
                                activeColor: kprimaryColor,
                                onChanged: (value) {
                                  controller.challengeDuration.value = value.toInt();
                                },
                              ),
                            ),
                          ),
              ...
              child: SizedBox(
                ...
                child: TextButton(
                  ...
                  onPressed: () async {
                    ...
                    // --- REMOVED BATTERY OPTIMIZATION CHECK HERE ---
                    if (await Permission.systemAlertWindow.isGranted) {
                      if (!controller.homeController.isProfile.value) {
                        ...
                        AlarmModel alarmRecord = AlarmModel(
                          ...
                          challengeDuration: controller.challengeDuration.value, // --- SAVING TO DB ---
                        );
