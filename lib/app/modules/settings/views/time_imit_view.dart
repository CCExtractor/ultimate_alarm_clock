      ...
      () => Material(
        ...
        child: InkWell(
          onTap: () {
            ...
            timeLimit = controller.challengeTimeLimit.value;
            Get.defaultDialog(
              onWillPop: () async {
                Get.back();
                controller.challengeTimeLimit.value = timeLimit;
                return true;
              },
                  ...
                  children: [
                    ...
                    Slider(
                      ...
                      onChanged: (double value) {
                        controller.challengeTimeLimit.value = value.toInt();
                      },
                      min: 5.0,
                      max: 60.0,
                      divisions: 55,
                ...
                child: ListTile(
                  ...
                  trailing: Wrap(
                    ...
                    children: [
                      Obx(
                        () => Text(
                          '${controller.challengeTimeLimit.value.round().toInt()} seconds',
