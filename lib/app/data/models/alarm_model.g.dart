...
void _alarmModelSerialize(
  ...
  writer.writeBool(offsets[23], object.isSpeakEnabled);
  ...
  writer.writeLong(offsets[35], object.numberOfWords);
...
AlarmModel _alarmModelDeserialize(
  ...
  final object = AlarmModel(
    ...
    isSpeakEnabled: reader.readBool(offsets[23]),
    ...
    numberOfWords: reader.readLong(offsets[35]),
...
extension AlarmModelQuerySortBy
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> sortByIsSpeakEnabled() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> sortByNumberOfWords() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'numberOfWords', Sort.asc);
    });
  }

  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> sortByNumberOfWordsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AlarmModelQuerySortThenBy
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> thenByIsSpeakEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSpeakEnabled', Sort.asc);
    });
  }
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> thenByNumberOfWords() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'numberOfWords', Sort.asc);
    });
  }

  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> thenByNumberOfWordsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'numberOfWords', Sort.desc);
    });
  }
...
extension AlarmModelQueryWhereDistinct
  ...
  QueryBuilder<AlarmModel, AlarmModel, QDistinct> distinctByIsSpeakEnabled() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AlarmModel, AlarmModel, QDistinct> distinctByNumberOfWords() {
    return QueryBuilder.apply(this, (query) {
...
extension AlarmModelQueryProperty
  ...
  QueryBuilder<AlarmModel, bool, QQueryOperations> isSpeakEnabledProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AlarmModel, int, QQueryOperations> numberOfWordsProperty() {
    return QueryBuilder.apply(this, (query) {
