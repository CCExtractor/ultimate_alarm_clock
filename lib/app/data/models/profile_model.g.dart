...
extension ProfileModelQuerySortBy
  ...
  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> sortByIsWifiEnabled() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> sortByWifiBSSID() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wifiBSSID', Sort.asc);
    });
  }

  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> sortByWifiBSSIDDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wifiBSSID', Sort.desc);
    });
  }

  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> sortByWifiName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wifiName', Sort.asc);
    });
  }

  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> sortByWifiNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileModelQuerySortThenBy
  ...
  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> thenByIsWifiEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isWifiEnabled', Sort.asc);
    });
  }
  ...
  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> thenByWifiBSSID() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wifiBSSID', Sort.asc);
    });
  }

  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> thenByWifiBSSIDDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wifiBSSID', Sort.desc);
    });
  }

  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> thenByWifiName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wifiName', Sort.asc);
    });
  }

  QueryBuilder<ProfileModel, ProfileModel, QAfterSortBy> thenByWifiNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wifiName', Sort.desc);
    });
  }
...
extension ProfileModelQueryWhereDistinct
  ...
  QueryBuilder<ProfileModel, ProfileModel, QDistinct> distinctByWifiBSSID(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProfileModel, ProfileModel, QDistinct> distinctByWifiName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileModelQueryProperty
  ...
  QueryBuilder<ProfileModel, bool, QQueryOperations> isWifiEnabledProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProfileModel, String, QQueryOperations> wifiBSSIDProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'wifiBSSID');
    });
  }

  QueryBuilder<ProfileModel, String, QQueryOperations> wifiNameProperty() {
    return QueryBuilder.apply(this, (query) {
