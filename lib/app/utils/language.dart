...
class AppTranslations extends Translations{
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US' : {
      ...
      'step2.1':'If you already have an account then enter your credentials. Otherwise, click on ',
      'step2.2':'Create an Account',
      'step2.3':' option. It asks you to Enter your username, email, and password. Make sure entered details are correct.',
      'step3':'Once your account is created, you are automatically directed to the OpenWeather page. It asks you about your company and the purpose of using the platform, fill this details accordingly.',
