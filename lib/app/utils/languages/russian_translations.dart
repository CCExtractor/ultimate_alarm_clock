...
class RussianTranslations extends Translations {
  ...
  'ru_RU' : {
    ...
    'Sign-inDescription' : 'Вход необязателен. Он требуется только для функций, использующих облачные службы, таких как:',
    'CollabDescription' : 'Сотрудничество с друзьями, членами семьи или коллегами, чтобы удостовериться, что они просыпаются вовремя с использованием общих будильников.',
    'Syncing Across Devices' : 'Синхронизация между устройствами',
    'AccessMultiple' : 'Доступ к вашим будильникам с нескольких устройств, где будильники обновляются в реальном времени.',
    'Your privacy' : 'Ваша конфиденциальность',
    'NoAccessInfo' : 'Мы не имеем доступа, не используем и не продаем никакую информацию, что вы можете проверить, изучив исходный код.',
    'LimitedAccess' : 'Весь доступ ограничен исключительно предоставлением описанных выше функций.',
