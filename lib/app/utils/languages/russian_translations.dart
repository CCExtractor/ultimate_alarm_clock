...
//photo_challenge_tile.dart
          ...
          'Photo': 'Фото',
          'photoDescription':
              'Это приложение для фотовызовов, которое превращает запечатление моментов в захватывающую игру! Сделайте снимок, чтобы начать вызов, затем соревнуйтесь с временем, чтобы воссоздать его и выключить сигнал тревоги. Готовы ли вы к вызову?',
          'Take Photo': 'Сделать фото',
          'Capture a Photo': 'Захватить фотографию',
